...
let calculateRectangleArea = (a , b) => {
    if (a > 0 && b > 0) {
        return a * b;
    } else {
...
let createAndWriteListFromArray = array => {
    let ul = `<ul>`;
